...
namespace App\Http\Controllers\Backend\UserAssigneEtape;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

class UserAssigneEtapeController extends Controller
{
    ...
    {
        $user = $request->user();
        $data = $this->model::with('user','processus_engage','etape');
