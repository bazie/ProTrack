...
class FaqController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validated->fails()) {
            ...
            if ($data=$this->model::create($request->all())) {
                ...
                $response=[
                    'status'=>TRUE, 'message'=>'Données enregistrées avec succès',
                ];
            }
            else {
                $response=[
                    'status'=>FALSE, 'message'=>'Les données n\'ont pas pu être enregistrées',
                ];
            }
        }
    ...
    public function destroy($id)
    {
        ...
        if ($data->delete()) {
            $response=[
                'status'=>TRUE, 'message'=>'Données supprimées avec succès',
            ];
        }
