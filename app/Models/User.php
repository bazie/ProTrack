...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'first_name', 'last_name', 'email', 'password', 'email_verified_at', 'level_id', 'access_group_id','id_office','statu',
    ];
    protected $hidden = [
        'password', 'remember_token','access_group_id','level_id','id_office','created_at','updated_at','deleted_at','email_verified_at','first_name','last_name'
    ];
    protected $casts = [
