                ...
                <div class="d-flex align-items-center">
                    <div class="me-auto">
                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"> {{ $page->subtitle ?? 'Page de gestion de menu' }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="panel-content">
                                        ...
                                        <div class="alert alert-success mb-0" role="alert">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1">
                                                    <span class="h5 m-0 fw-700"><i class="{{ $page->icon }}"></i> Liste des Menus {!! config('master.app.profile.name') !!} !</span>
                                                    Organisez correctement le menu.
                                                </div>
                                            </div>
                                        </div>
...
@push('js')
    ...
    <script src="{{ url('js/'.$backend.'/'.$page->code.'/datatabe.js') }}"></script>
