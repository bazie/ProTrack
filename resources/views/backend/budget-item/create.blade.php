...
<div class="panel shadow-sm">
    <div class="panel-body">
		...
		<div class='form-group'>
			...
			{!! html()->text('activity_description',NULL)->placeholder('Type Activity Description here')->class('form-control')->id('activity_description') !!}
		</div>
		<div class='form-group'>
		...
		<div class='form-group'>
			...
			{!! html()->text('sap_output_code',NULL)->placeholder('Type Sap Output Code here')->class('form-control')->id('sap_output_code') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('cost_centre')->text('Cost Centre') !!}
			{!! html()->text('cost_centre',NULL)->placeholder('Type Cost Centre here')->class('form-control')->id('cost_centre') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('gl_account')->text('Gl Account') !!}
			{!! html()->text('gl_account',NULL)->placeholder('Type Gl Account here')->class('form-control')->id('gl_account') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('grant')->text('Grant') !!}
			{!! html()->text('grant',NULL)->placeholder('Type Grant here')->class('form-control')->id('grant') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('fund')->text('Fund') !!}
			{!! html()->text('fund',NULL)->placeholder('Type Fund here')->class('form-control')->id('fund') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('number_of_unit')->text('Number Of Unit') !!}
			{!! html()->number('number_of_unit',NULL)->placeholder('Type Number Of Unit here')->class('form-control')->id('number_of_unit') !!}
		</div>
		<div class='form-group'>
		...
		<div class='form-group'>
			...
			{!! html()->number('unit_cost',NULL)->placeholder('Type Unit Cost here')->class('form-control')->id('unit_cost') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('quantity')->text('Quantity') !!}
			{!! html()->number('quantity',NULL)->placeholder('Type Quantity here')->class('form-control')->id('quantity') !!}
		</div>
    </div>
</div>
