        ...
        <div class="row">
			<div class="col-md-6">
				<div class="form-group">
					{!! html()->span()->text("Type Entite")->class("control-label") !!}
					{!! html()->p($data->type_entite)->class("form-control") !!}
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
			...
			<div class="col-md-6">
				<div class="form-group">
					{!! html()->span()->text("Departement")->class("control-label") !!}
					{!! html()->p($data->departement_id)->class("form-control") !!}
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
