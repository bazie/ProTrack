...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
			{!! html()->label()->class('control-label')->for('categorie_lib')->text('Categorie Lib') !!}
			{!! html()->text('categorie_lib',$data->categorie_lib)->placeholder('Type Categorie Lib here')->class('form-control')->id('categorie_lib') !!}
		</div>
    </div>
</div>
