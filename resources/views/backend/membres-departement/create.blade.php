...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
            ...
            {!! html()->select('departement_id', $departements)->placeholder('Selectionner le departement')->class('form-control select2')->id('departement_id') !!}
        </div>
        <div class='form-group'>
            {!! html()->label()->class('control-label')->for('user_id')->text('Utilisateur') !!}
            {!! html()->select('user_id', $users)->placeholder('Selecetionner l\'utilisateur')->class('form-control select2')->id('user_id')->required() !!} 
        </div>
    </div>
</div>
