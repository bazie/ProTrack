                ...
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="end-date">
                                    ...
                                    En vigueur: {{ date('d M Y', strtotime($data->start)) }} - {{ date('d M Y', strtotime($data->end)) }}
                                    <span class="pull-right">Se termine dans :{!! $data->daysLeft !!} </span>
                                </div>
                                <div class="urgency">
                                    <span class="fa fa-exclamation-triangle"></span> Nature de l'annonce :
                                ...
                                <div class="file p-10 mt-3">
                                    <span class="fa fa-paperclip"></span> Fichiers support :
                        ...
                        <button type="button" class="btn btn-sm btn-danger pull-right" onclick="window.close();">
                            <span class="fa fa-times"></span> Fermer la page
                        </button>
                    </div>
                </div>
            </section>
