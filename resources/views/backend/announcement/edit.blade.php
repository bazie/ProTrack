...
<div class="panel shadow-sm">
    <div class="panel-body">
        ...
        <div class='form-group'>
            ...
            <span class="text-danger">*</span>
            {!! html()->text('title',$data->title)->placeholder('Tapez ici')->class('form-control')->id('title')->required() !!}
        </div>
        <div class="row">
        ...
        <div class='form-group'>
            ...
            <span class="text-danger">*</span>
            {!! html()->textarea('content',htmlspecialchars($data->content))->class('form-control')->id('content')->placeholder('Tapez ici')->required() !!}
        </div>
        <div class='form-group'>
        ...
        @if(!$data->file->isEmpty())
            <div class="form-group">
                <label class="control-label">Fichiers de support actuels :</label>
                <table class="table">
                        ...
                        <tr id="{{ $file->id }}">
                            ...
                            <td>
                                <a href="#delete" class="btn btn-danger btn-xs delete-file" data-title="Delete" data-id="{{ $file->id }}" data-url="{{ $file->link_delete }}" data-message="Do you want to delete this data ?">
                                    <span class="fa fa-trash"></span> Supprimer le fichier
                                </a>
                            </td>
                        </tr>
                    @endforeach
