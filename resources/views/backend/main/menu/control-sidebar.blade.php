<aside class="control-sidebar">
    ...
    <div class="tab-content">
        <div class="flexbox">
            <p><i class="fa fa-bullhorn"></i> Bonjour, comment pouvons-nous vous aider ?</p>
        </div>
        <div class="lookup lookup-sm lookup-right d-lg-block">
            <input type="text" id="search-faq" name="search" placeholder="Recherchez ici..." class="w-p100">
        </div>
        ...
        <div class="flexbox justify-content-center">
            <a href="{!! url(config('master.app.url.backend').'/question') !!}" class="text-center">
                <i class="mdi mdi-playlist-check"></i> Tout voir
            </a>
        </div>
    </div>
</aside>
