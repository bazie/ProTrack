            ...
            <ul class="nav navbar-nav">
                    ...
                    <div class="app-menu">
                        <div class="search-bx mx-5">
                            <div class="input-group">
                                <input type="search" class="form-control search-menu" placeholder="Recherchez le menu ici..." aria-label="Search" aria-describedby="button-addon2" name="search_menu">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu animated bounceIn">
                        <li class="header">
                            <div class="p-20">
                                <div class="flexbox">
                                    ...
                                    <div>
                                        <a href="#" class="text-danger" id="clear-notification">Effacer</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="footer">
                            <a href="{!! url(config('master.app.url.backend').'/notification') !!}">Tout voir</a>
                        </li>
                    </ul>
                </li>
