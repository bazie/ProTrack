...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
            ...
            {!! html()->text('lib_processus', null)->placeholder('Type Lib Processus here')->class('form-control')->id('lib_processus') !!}
        </div>
        <div class='form-group'>
            {!! html()->label()->class('control-label')->for('description')->text('Description') !!}
            {!! html()->textarea('description', null)->placeholder('Type Description here')->class('form-control')->id('description') !!}
        </div>
    </div>
</div>
