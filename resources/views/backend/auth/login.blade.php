                            ...
                            <!--
                                <div class="col-md-4 col-lg-4 align-items-center hidden-lg-down me-0">
                                    ...
                                    <img id="header-image-vector" class="pull-right p-5" width="90" height="90"
                                        src="{!! url(config('master.app.web.template') . '/assets/vector/sleeping.png') !!}" alt="avatar">
                                   
                                </div>
                                 -->
                                <div class="col-md-12 col-lg-12 col-12 pull-left hidden-lg-down ms-0 text-center">
                                    <h1 class="text-primary">{!! config('master.app.profile.name') !!}</h1>
                                    <p class="mb-0">Connectez-vous pour continuer sur {!! config('master.app.profile.short_name') !!}.</p>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="email" id="email" type="text"
                                            class="form-control ps-15 bg-transparent" placeholder="Email" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="password" type="password" id="password"
                                            class="form-control ps-15 bg-transparent" placeholder="Mot de passe"
                                            autocomplete="off" required>
                                        <span class="input-group-text show-hide-password bg-transparent"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="fog-pwd text-end">
                                            <a href="#" class="hover-warning"><i class="ion ion-locked"></i>Mot de
                                                passe oublié ?</a><br>
                                        </div>
                                    </div>
                                    <div class="col-12 text-center">
                                        <button type="button" id="go-login"
                                            class="btn btn-dark mt-10 text-white fw-bold">SE CONNECTER</button>
                                    </div>
                                </div>
                            </form>
                            <!--
