...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
			{!! html()->label()->class('control-label')->for('lib_module')->text('Lib Module') !!}
			{!! html()->text('lib_module',NULL)->placeholder('Type Lib Module here')->class('form-control')->id('lib_module') !!}
		</div>
    </div>
</div>
