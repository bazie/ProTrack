$(document).ready(function () {
	$('#datatable').DataTable({
		...
		columns: [
			...
			{ data: 'processus_engage_id' , 'defaultContent':''},
			{ data: 'etape_id' , 'defaultContent':''},
			{ data: 'date_assignation' , 'defaultContent':''},
			{ data: 'approbation' , 'defaultContent':''},
			{ data: 'date_approbation' , 'defaultContent':''},
			{ data: 'commentaire' , 'defaultContent':''},
