...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
			{!! html()->label()->class('control-label')->for('short_name')->text('Short Name') !!}
			{!! html()->text('short_name',NULL)->placeholder('Type Short Name here')->class('form-control')->id('short_name') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('name')->text('Name') !!}
			{!! html()->text('name',NULL)->placeholder('Type Name here')->class('form-control')->id('name') !!}
		</div>
    </div>
</div>
