...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
			{!! html()->label()->class('control-label')->for('office_name')->text('Office Name') !!}
			{!! html()->text('office_name',$data->office_name)->placeholder('Type Office Name here')->class('form-control')->id('office_name') !!}
		</div>
    </div>
</div>
