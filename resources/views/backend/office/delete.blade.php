{!! html()->form('DELETE', route($page->code.'.destroy', $data->id_office))->id('form-create-'.$page->code)->class('form form-horizontal')->open() !!}
<div class="row">
    <div class="col-md-12">
        ...
        <div class="info-data">
            <div class="panel">
                <div class="panel-body panel-dark bg-dark">
                    @foreach(collect(json_decode($data,TRUE))->except(['id_office','created_at','updated_at','deleted_at']) as $key => $value)
                        <p>
                            <code>{{ $key }}</code>
